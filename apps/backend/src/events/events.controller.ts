import { Body, Controller, Get, Post, Put, UploadedFile, UseGuards, UseInterceptors, Res } from '@nestjs/common';
...
export class EventsController {
  ...
  async getPublicConfig(@Res() res: Response) {
    ...
    // Cache short time; change rarely but reduces load for many devices
  ...
  @UseGuards(JwtAuthGuard)
  @UseInterceptors(FileInterceptor('logo', { storage: logosStorage() }))
  ...
  @UseGuards(JwtAuthGuard)
  @UseInterceptors(FileInterceptor('background', { storage: backgroundsStorage() }))
